    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecruitmentAnalytics", x => x.AnalyticsId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillsSummary = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    ...
                    IsOpenToOpportunities = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    AvailableFrom = table.Column<DateTime>(type: "datetime2", nullable: true),
                    WillingToRelocate = table.Column<bool>(type: "bit", nullable: false),
                    WillingToWorkRemote = table.Column<bool>(type: "bit", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportingTo = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_JobPostings_HiringManagers_HiringManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InterviewedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalScore = table.Column<decimal>(type: "decimal(3,1)", precision: 3, scale: 1, nullable: false),
                    BehavioralScore = table.Column<decimal>(type: "decimal(3,1)", precision: 3, scale: 1, nullable: false),
                    CommunicationScore = table.Column<decimal>(type: "decimal(3,1)", precision: 3, scale: 1, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobPostings_Department_Status",
                table: "JobPostings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecruitmentAnalytics_Department_Date_MetricName",
                table: "RecruitmentAnalytics",
                columns: new[] { "Department", "Date", "MetricName" });
